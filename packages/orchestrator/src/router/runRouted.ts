 ...
 * runs with the default topology (single: kimi one shot; compete: lanes kimi+qwen,
 * reviewer kimi; brainstorm: same lanes, synthesizer kimi; cascade: qwen → kimi,
 * cheapest first; roundtable: kimi+qwen at the table, kimi synthesizer). The
